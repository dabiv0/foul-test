...
exports.replog = true;
exports.saveReplays = true;
exports.uploadReplays = false;
exports.replayUrl = 'http://localhost:8000/replay/';
exports.saveUnratedReplays = true;
...
exports.allowRenames = true;

exports.validateChannels = false;
...
console.log('Using serverid:', exports.serverid);

console.log('Using replog:', exports.replog);
console.log('Using saveReplays:', exports.saveReplays);
console.log('Using uploadReplays:', exports.uploadReplays);
console.log('Using replayUrl:', exports.replayUrl);
console.log('Using loglevel:', exports.loglevel);
