...
var battle_animations_moves_exports = {};
__export(battle_animations_moves_exports, {
  BattleMoveAnims: () => BattleMoveAnims
});
module.exports = __toCommonJS(battle_animations_moves_exports);
...
const BattleMoveAnims = {
  taunt: {
    anim(scene, [attacker, defender]) {
      import_battle_animations.BattleOtherAnims.dance.anim(scene, [attacker, defender]);
  ...
  swagger: {
    anim(scene, [attacker, defender]) {
      import_battle_animations.BattleOtherAnims.shake.anim(scene, [attacker]);
      scene.showEffect("angry", {
        x: defender.x + 20,
        y: defender.y + 20,
        z: defender.z,
  ...
  swordsdance: {
    anim(scene, [attacker, defender]) {
      import_battle_animations.BattleOtherAnims.shake.anim(scene, [defender]);
  ...
  doubleteam: {
    anim(scene, [attacker, defender]) {
      import_battle_animations.BattleOtherAnims.shake.anim(scene, [attacker, defender]);
      scene.showEffect(attacker.sp, {
        x: defender.x,
        y: attacker.y,
        z: attacker.z,
  ...
  teeterdance: {
    anim: import_battle_animations.BattleOtherAnims.shake.anim
  },
  splash: {
    anim(scene, [attacker]) {
  ...
  raindance: {
    anim: import_battle_animations.BattleOtherAnims.dance.anim
  },
  sunnyday: {
    anim: import_battle_animations.BattleOtherAnims.dance.anim
  },
  ...
  chillyreception: {
    anim(scene, [attacker, defender]) {
      ...
      scene.backgroundEffect(`url('https://${import_client_main.Config.routes.client}/fx/weather-hail.png')`, 750, 1, 800);
    }
  },
  sandstorm: {
    anim: import_battle_animations.BattleOtherAnims.dance.anim
  ...
  followme: {
    anim(scene, [attacker]) {
      import_battle_animations.BattleOtherAnims.dance.anim(scene, [attacker]);
      scene.showEffect("pointer", {
        x: attacker.x,
        y: attacker.y + 30,
        z: attacker.z,
  ...
  electricterrain: {
    anim(scene, [attacker]) {
      scene.backgroundEffect("#FFFF00", 1e3, 0.3);
      import_battle_animations.BattleOtherAnims.dance.anim(scene, [attacker]);
    }
  },
  grassyterrain: {
    anim(scene, [attacker]) {
      scene.backgroundEffect("#9AB440", 1e3, 0.3);
      import_battle_animations.BattleOtherAnims.dance.anim(scene, [attacker]);
    }
  },
  mistyterrain: {
  ...
  junglehealing: {
    anim(scene, [attacker, ...defenders]) {
      scene.backgroundEffect("#9AB440", 1e3, 0.3);
      for (const defender of defenders) {
        import_battle_animations.BattleOtherAnims.dance.anim(scene, [defender]);
  ...
  bravebird: {
    anim: import_battle_animations.BattleOtherAnims.flight.anim
  },
  acrobatics: {
    anim: import_battle_animations.BattleOtherAnims.flight.anim
  },
  ...
  orderup: {
    anim(scene, [attacker, defender]) {
      const tatsugiriSprite = {
        url: `https://${import_client_main.Config.routes.client}/sprites/gen5/tatsugiri${["-droopy", "-stretchy", ""][Math.floor(Math.random() * 3)]}.png`,
        w: 96,
        h: 96
      };
  ...
  flail: {
    anim: import_battle_animations.BattleOtherAnims.xattack.anim
  },
  uturn: {
    anim: import_battle_animations.BattleOtherAnims.spinattack.anim
  },
  flipturn: {
    anim(scene, [attacker, defender]) {
      scene.showEffect("waterwisp", {
      ...
      import_battle_animations.BattleOtherAnims.spinattack.anim(scene, [attacker, defender]);
    }
  },
  rapidspin: {
    anim: import_battle_animations.BattleOtherAnims.spinattack.anim
  ...
  populationbomb: {
    anim(scene, [attacker, defender]) {
      import_battle_animations.BattleOtherAnims.contactattack.anim(scene, [attacker, defender]);
      scene.showEffect("fireball", {
        x: defender.x + 40,
        y: defender.y,
        z: defender.z,
  ...
  aromatherapy: {
    anim: import_battle_animations.BattleOtherAnims.selfstatus.anim
  },
  healbell: {
    anim: import_battle_animations.BattleOtherAnims.selfstatus.anim
  },
  ...
  bide: {
    anim: import_battle_animations.BattleOtherAnims.bidecharge.anim
  },
  focusenergy: {
    anim: import_battle_animations.BattleOtherAnims.selfstatus.anim
  },
  ...
  milkdrink: {
    anim: import_battle_animations.BattleOtherAnims.consume.anim
  },
  happyhour: {
    anim: import_battle_animations.BattleOtherAnims.selfstatus.anim
  },
  ...
  barrier: {
    anim: import_battle_animations.BattleOtherAnims.lightstatus.anim
  },
  morningsun: {
    anim(scene, [attacker, defender]) {
      scene.backgroundEffect(`url('https://${import_client_main.Config.routes.client}/fx/weather-sunnyday.jpg')`, 700, 0.5);
      scene.showEffect("wisp", {
        x: attacker.x + 40,
        y: attacker.y - 40,
        z: attacker.z,
  ...
  moonlight: {
    anim(scene, [attacker]) {
      scene.backgroundEffect(`url('https://${import_client_main.Config.routes.client}/fx/bg-space.jpg')`, 800, 0.6);
  ...
  cosmicpower: {
    anim(scene, [attacker]) {
      scene.backgroundEffect(`url('https://${import_client_main.Config.routes.client}/fx/bg-space.jpg')`, 600, 0.6);
      scene.showEffect("wisp", {
        x: attacker.x + 40,
        y: attacker.y - 40,
        z: attacker.z,
  ...
  geomancy: {
    ...
    prepareAnim: import_battle_animations.BattleOtherAnims.chargestatus.anim
  },
  magnetrise: {
    anim(scene, [attacker]) {
      scene.showEffect("wisp", {
  ...
  recover: {
    anim: import_battle_animations.BattleOtherAnims.chargestatus.anim
  },
  shadowforce: {
    anim(scene, [attacker, defender]) {
      scene.backgroundEffect("#000000", 1e3, 0.3);
  ...
  skydrop: {
    anim: import_battle_animations.BattleOtherAnims.contactattack.anim,
  ...
  crushclaw: {
    anim: import_battle_animations.BattleOtherAnims.clawattack.anim
  },
  falseswipe: {
    anim: import_battle_animations.BattleOtherAnims.slashattack.anim
  },
  direclaw: {
    anim: import_battle_animations.BattleOtherAnims.clawattack.anim
  },
  ...
  shadowclaw: {
    anim(scene, [attacker, defender]) {
      scene.backgroundEffect("#000000", 700, 0.3);
      import_battle_animations.BattleOtherAnims.clawattack.anim(scene, [attacker, defender]);
    }
  },
  multiattack: {
    anim(scene, [attacker, defender]) {
  ...
  seismictoss: {
    anim(scene, [attacker, defender]) {
      scene.backgroundEffect(`url('https://${import_client_main.Config.routes.client}/fx/bg-space.jpg')`, 500, 0.6, 300);
      scene.showEffect("wisp", {
        x: defender.x,
        y: defender.y + 10,
        z: defender.z,
  ...
  bite: {
    anim(scene, [attacker, defender]) {
      import_battle_animations.BattleOtherAnims.bite.anim(scene, [attacker, defender]);
      import_battle_animations.BattleOtherAnims.contactattack.anim(scene, [attacker, defender]);
    }
  },
  superfang: {
  ...
  blazekick: {
    anim(scene, [attacker, defender]) {
      ...
      import_battle_animations.BattleOtherAnims.kick.anim(scene, [attacker, defender]);
      import_battle_animations.BattleOtherAnims.contactattack.anim(scene, [attacker, defender]);
    }
  },
  lowkick: {
  ...
  leafblade: {
    anim(scene, [attacker, defender]) {
      import_battle_animations.BattleOtherAnims.xattack.anim(scene, [attacker, defender]);
      scene.showEffect("energyball", {
        x: defender.x,
        y: defender.y,
        z: defender.z,
  ...
  meteormash: {
    anim(scene, [attacker, defender]) {
      scene.backgroundEffect(`url('https://${import_client_main.Config.routes.client}/fx/bg-space.jpg')`, 1e3, 0.4);
      scene.showEffect(attacker.sp, {
      ...
      import_battle_animations.BattleOtherAnims.punchattack.anim(scene, [attacker, defender]);
    }
  },
  shadowpunch: {
    anim(scene, [attacker, defender]) {
  ...
  cometpunch: {
    anim: import_battle_animations.BattleOtherAnims.punchattack.anim
  },
  megapunch: {
    anim: import_battle_animations.BattleOtherAnims.punchattack.anim
  },
  ...
  absorb: {
    anim: import_battle_animations.BattleOtherAnims.drain.anim
  },
  megadrain: {
    anim(scene, [attacker, defender]) {
      scene.backgroundEffect("#9AB440", 900, 0.2);
      import_battle_animations.BattleOtherAnims.drain.anim(scene, [attacker, defender]);
    }
  },
  gigadrain: {
    anim(scene, [attacker, defender]) {
  ...
  quickattack: {
    anim: import_battle_animations.BattleOtherAnims.fastattack.anim
  },
  suckerpunch: {
    anim(scene, [attacker, defender]) {
      import_battle_animations.BattleOtherAnims.fastattack.anim(scene, [attacker, defender]);
      scene.showEffect("impact", {
        x: defender.x,
        y: defender.y,
        z: defender.behind(5),
  ...
  feint: {
    anim: import_battle_animations.BattleOtherAnims.sneakattack.anim
  },
  thief: {
    anim: import_battle_animations.BattleOtherAnims.sneakattack.anim
  },
  shadowsneak: {
    anim(scene, [attacker, defender]) {
      scene.backgroundEffect("#000000", 700, 0.3);
      import_battle_animations.BattleOtherAnims.sneakattack.anim(scene, [attacker, defender]);
    }
  },
  feintattack: {
    anim: import_battle_animations.BattleOtherAnims.sneakattack.anim
  ...
  drillrun: {
    // todo: rip horn sprite and redo animation
    anim(scene, [attacker, defender]) {
      attacker.anim({
        x: defender.x,
        y: defender.y,
  ...
  wildboltstorm: {
    anim(scene, [attacker, ...defenders]) {
      scene.backgroundEffect("#F6D434", 1e3, 0.3);
      for (const defender of defenders) {
  ...
  sandsearstorm: {
    anim(scene, [attacker, ...defenders]) {
      scene.backgroundEffect("#B47F1F", 1e3, 0.3);
      for (const defender of defenders) {
        for (let i = 0; i < 4; i++) {
          scene.showEffect("mudwisp", {
            x: defender.x + 50,
  ...
  roar: {
    anim: import_battle_animations.BattleOtherAnims.sound.anim
  },
  round: {
    anim: import_battle_animations.BattleOtherAnims.sound.anim
  },
  ...
  defog: {
    anim(scene, [attacker, defender]) {
      ...
      import_battle_animations.BattleOtherAnims.sound.anim(scene, [attacker, defender]);
    }
  },
  grasswhistle: {
    anim(scene, [attacker, defender]) {
  ...
  psystrike: {
    anim(scene, [attacker, defender]) {
      scene.backgroundEffect(`url('https://${import_client_main.Config.routes.client}/fx/weather-psychicterrain.png')`, 950, 0.6);
      scene.showEffect("poisonwisp", {
        x: defender.x - 100,
        y: defender.y,
        z: defender.z,
  ...
  infernalparade: {
    anim(scene, [attacker, defender]) {
      scene.backgroundEffect("#BB59FF", 1e3, 0.4);
  ...
  flowertrick: {
    anim(scene, [attacker, defender]) {
      scene.backgroundEffect(`#000000`, 1e3, 0.4);
      scene.showEffect("energyball", {
        x: attacker.x,
        y: attacker.y,
        z: attacker.z,
  ...
  wish: {
    anim(scene, [attacker]) {
      scene.backgroundEffect(`url('https://${import_client_main.Config.routes.client}/fx/bg-space.jpg')`, 600, 0.4);
      scene.showEffect("wisp", {
        x: attacker.x,
        y: attacker.y,
        z: attacker.z,
  ...
  dracometeor: {
    anim(scene, [attacker, defender]) {
      scene.backgroundEffect(`url('https://${import_client_main.Config.routes.client}/fx/bg-space.jpg')`, 1100, 0.8);
      scene.showEffect("flareball", {
  ...
  brine: {
    anim: import_battle_animations.BattleOtherAnims.hydroshot.anim
  },
  octazooka: {
    anim(scene, [attacker, defender]) {
      scene.showEffect("blackwisp", {
  ...
  scald: {
    anim(scene, [attacker, defender]) {
      import_battle_animations.BattleOtherAnims.hydroshot.anim(scene, [attacker, defender]);
      scene.showEffect("wisp", {
        x: defender.x + 30,
        y: defender.y,
        z: defender.z,
  ...
  solarbeam: {
    anim(scene, [attacker, defender]) {
      ...
      let zstep = (defender.z - attacker.z) / 5;
      scene.backgroundEffect(`url('https://${import_client_main.Config.routes.client}/fx/weather-sunnyday.jpg')`, 900, 0.5);
      for (let i = 0; i < 5; i++) {
        scene.showEffect("energyball", {
          x: attacker.x + xstep * (i + 1),
  ...
  meteorbeam: {
    anim(scene, [attacker, defender]) {
      ...
      let ystep = (defender.x - 200 - attacker.x) / 5;
      let zstep = (defender.z - attacker.z) / 5;
      scene.backgroundEffect(`url('https://${import_client_main.Config.routes.client}/fx/weather-sandstorm.png')`, 900, 0.5);
      for (let i = 0; i < 5; i++) {
        scene.showEffect("mudwisp", {
          x: attacker.x + xstep * (i + 1),
          y: attacker.y + 200 + ystep * (i + 1),
  ...
  sheercold: {
    // Reminder: Improve this later
    anim(scene, [attacker, defender]) {
      scene.backgroundEffect(`url('https://${import_client_main.Config.routes.client}/sprites/gen6bgs/bg-icecave.jpg')`, 1e3, 0.6);
      scene.showEffect("icicle", {
        x: defender.x,
        y: defender.y,
        z: defender.z,
  ...
  freezeshock: {
    ...
    prepareAnim: import_battle_animations.BattleOtherAnims.selfstatus.anim
  },
  iceburn: {
    anim(scene, [attacker, defender]) {
      scene.showEffect("iceball", {
  ...
  dragonascent: {
    anim(scene, [attacker, defender]) {
      scene.backgroundEffect(`url('https://${import_client_main.Config.routes.client}/fx/bg-space.jpg')`, 1e3, 0.7);
      scene.showEffect("iceball", {
  ...
  diamondstorm: {
    // todo: new animation involving icicles
    anim(scene, [attacker, defender]) {
  ...
  spiritshackle: {
    anim(scene, [attacker, defender]) {
      scene.backgroundEffect("linear-gradient(#440044 30%, #000000", 1e3, 0.4);
      scene.showEffect("shadowball", {
        x: attacker.x,
        y: attacker.y,
        z: attacker.z,
  ...
  plasmafists: {
    anim(scene, [attacker, defender]) {
      scene.backgroundEffect(`url('https://${import_client_main.Config.routes.client}/sprites/gen6bgs/bg-earthycave.jpg')`, 2e3, 1);
      scene.backgroundEffect("#000000", 1e3, 0.6);
      scene.backgroundEffect("#FFFFFF", 300, 0.6, 1e3);
      scene.showEffect("electroball", {
        x: attacker.x,
        y: attacker.y,
        z: attacker.z,
  ...
  collisioncourse: {
    anim(scene, [attacker, defender]) {
      scene.backgroundEffect(`url('https://${import_client_main.Config.routes.client}/fx/weather-sunnyday.jpg')`, 1300, 0.5);
      scene.showEffect(attacker.sp, {
        x: attacker.x,
        y: attacker.y,
        z: attacker.z,
  ...
  electrodrift: {
    anim(scene, [attacker, defender]) {
      scene.backgroundEffect(`url('https://${import_client_main.Config.routes.client}/fx/weather-electricterrain.png')`, 1300, 0.5);
      scene.showEffect(attacker.sp, {
        x: attacker.x,
        y: attacker.y,
        z: attacker.z,
  ...
  photongeyser: {
    anim(scene, [attacker, defender]) {
      scene.backgroundEffect("#000000", 1e3, 0.5);
  ...
  coreenforcer: {
    anim(scene, [attacker, ...defenders]) {
      ...
      scene.backgroundEffect("#ffffff", 800, 0.8, 2e3);
      scene.showEffect("fireball", {
        x: defender.x + 40,
        y: defender.y,
        z: defender.z,
  ...
  alloutpummeling: {
    anim(scene, [attacker, defender]) {
      scene.backgroundEffect("linear-gradient(#390000 30%, #B84038)", 2e3, 0.8);
      scene.showEffect("flareball", {
        x: attacker.x,
        y: attacker.y,
        z: attacker.z,
  ...
  oceanicoperetta: {
    anim(scene, [attacker, defender]) {
      ...
      scene.backgroundEffect(`url('https://${import_client_main.Config.routes.client}/fx/weather-raindance.jpg')`, 700, 0.2, 2e3);
      scene.showEffect("iceball", {
        x: attacker.x,
        y: attacker.y + 120,
        z: attacker.z,
  ...
  splinteredstormshards: {
    anim(scene, [attacker, defender]) {
      scene.backgroundEffect(`url('https://${import_client_main.Config.routes.client}/sprites/gen6bgs/bg-earthycave.jpg')`, 2700, 0.8, 300);
  ...
  clangoroussoulblaze: {
    anim(scene, [attacker, ...defenders]) {
      ...
      scene.backgroundEffect(`url('https://${import_client_main.Config.routes.client}/sprites/gen6bgs/bg-earthycave.jpg')`, 2e3, 0.7, 300);
      scene.backgroundEffect("linear-gradient(#FB5C1E 20%, #3F1D0F", 2e3, 0.6, 300);
      scene.backgroundEffect("#FFFFFF", 1e3, 0.9, 2200);
      scene.showEffect("shine", {
        x: attacker.x - 10,
        y: attacker.y - 10,
        z: attacker.z,
  ...
  searingsunrazesmash: {
    anim(scene, [attacker, defender]) {
      ...
      let ystep = (defender.x - 200 - attacker.x) / 5;
      let zstep = (defender.z - attacker.z) / 5;
      scene.backgroundEffect(`url('https://${import_client_main.Config.routes.client}/fx/weather-trickroom.png')`, 700, 1);
      scene.backgroundEffect(`url('https://${import_client_main.Config.routes.client}/fx/bg-space.jpg')`, 2500, 1, 700);
  ...
  stompingtantrum: {
    anim(scene, [attacker, defender]) {
      import_battle_animations.BattleOtherAnims.anger.anim(scene, [attacker, defender]);
      attacker.anim({
        y: attacker.y + 20,
        time: 175
      }, "swing");
  ...
  temperflare: {
    anim(scene, [attacker, defender]) {
      ...
      let xf2 = [1, 0, -1, 0];
      let yf2 = [0, 1, 0, -1];
      scene.backgroundEffect("linear-gradient(#390000 30%, #B84038)", 1e3, 0.3);
      for (let i = 0; i < 4; i++) {
        scene.showEffect("flareball", {
          x: attacker.x,
          y: attacker.y,
  ...
  stoneaxe: {
    anim(scene, [attacker, defender]) {
      import_battle_animations.BattleOtherAnims.slashattack.anim(scene, [attacker, defender]);
      scene.showEffect("rock1", {
        x: defender.x,
        y: defender.y,
        z: defender.z,
