...
var battle_dex_data_exports = {};
__export(battle_dex_data_exports, {
  Ability: () => Ability,
  BattleAvatarNumbers: () => BattleAvatarNumbers,
  BattleBaseSpeciesChart: () => BattleBaseSpeciesChart,
  BattleNatures: () => BattleNatures,
  BattlePokemonIconIndexes: () => BattlePokemonIconIndexes,
  BattlePokemonIconIndexesLeft: () => BattlePokemonIconIndexesLeft,
  BattleStatIDs: () => BattleStatIDs,
  BattleStatNames: () => BattleStatNames,
  Item: () => Item,
  Move: () => Move,
  PureEffect: () => PureEffect,
  Species: () => Species
});
module.exports = __toCommonJS(battle_dex_data_exports);
...
class Item {
  constructor(id, name, data) {
    ...
    this.name = import_battle_dex.Dex.sanitizeName(name);
    this.id = id;
    this.gen = data.gen || 0;
...
class Species {
  constructor(id, name, data) {
    ...
    const baseId = (0, import_battle_dex.toID)(this.baseSpecies);
    this.formeid = baseId === this.id ? "" : "-" + (0, import_battle_dex.toID)(this.forme);
