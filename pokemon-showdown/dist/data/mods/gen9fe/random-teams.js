...
__export(random_teams_exports, {
  RandomFERBTeams: () => RandomFERBTeams,
...
const ferbSets = {
  ...
  "Whimsy Sands": {
    species: "Whimsy Sands",
    ability: "Once Upon a Time",
    item: "Leftovers",
    gender: "N",
  ...
  "Urshiluxe-Rapid-Strike": {
    species: "Urshiluxe-Rapid-Strike",
    ability: "Snowblind",
    item: "Assault Vest",
    gender: "",
  ...
  "Baxgeist-Large": {
    species: "Baxgeist-Large",
    ability: "Frisk Exchange",
    item: "Life Orb",
    gender: "",
  ...
  "Necrotrik-Dawn-Wings": {
    species: "Necrotrik-Dawn-Wings",
    ability: "Airborne Armor",
    item: "Leftovers",
    gender: "N",
  ...
  "Necrotrik-Ultra": {
    species: "Necrotrik-Dawn-Wings",
    ability: "Airborne Armor",
    item: "Depleted Ultranecrozium Z",
    gender: "N",
    ...
    teraType: "Water",
    level: 85,
    skip: "Necrotrik-Dawn-Wings"
  },
  Druddizor: {
    species: "Druddizor",
    ability: "Bleeding Edge",
    item: "Leftovers",
    gender: "",
  ...
  "Scream Cormorant": {
    species: "Scream Cormorant",
    ability: "Prehistoric Hunter",
    item: "Rocky Helmet",
    gender: "N",
  ...
  "Amigotrio-Alola": {
    species: "Amigotrio-Alola",
    ability: "Lively Locks",
    item: "Life Orb",
    gender: "",
  ...
  "Deoxyslash-Speed": {
    species: "Deoxyslash-Speed",
    ability: "Forced Fencer",
  ...
  "Golisoros-Paldea-Blaze": {
    species: "Golisoros-Paldea-Blaze",
    ability: "Mad Cow",
    item: "Leftovers",
    gender: "M",
  ...
  "Maractorus-Therian": {
    species: "Maractorus-Therian",
    ability: "Daunting Storm",
    item: "Leftovers",
    gender: "M",
  ...
  Lunarunt: {
    species: "Lunarunt",
    ability: "Unidentified Flying Object",
    item: "Colbur Berry",
    gender: "N",
  ...
  "Bronze Bonnet": {
    species: "Bronze Bonnet",
    ability: "Weight of Life",
    item: "Booster Energy",
    gender: "N",
  ...
  "Empoliary-Hisui": {
    species: "Empoliary-Hisui",
    ability: "Sharp Goggles",
    item: "Leftovers",
    gender: "",
  ...
  "Appleking-Galar": {
    species: "Appleking-Galar",
    ability: "Healthy Diet",
    item: "Assault Vest",
    gender: "",
  ...
  "Fishkarp-Hisui": {
    species: "Fishkarp-Hisui",
    ability: "Fishy Threat",
    item: "Eviolite",
    gender: "",
...
class RandomFERBTeams extends import_teams.default {
  randomFERBTeam(options = {}) {
    ...
    while (pool.length && team.length < this.maxTeamSize) {
      ...
      const ferbSet = this.dex.deepClone(ferbSets[name]);
      ...
      let teraType;
      if (ferbSet.teraType) {
        teraType = ferbSet.teraType === "Any" ? this.sample(this.dex.types.names()) : this.sampleIfArray(ferbSet.teraType);
      }
      const moves = [];
      ...
      const set = {
        ...
        evs: ferbSet.evs ? { hp: 0, atk: 0, def: 0, spa: 0, spd: 0, spe: 0, ...ferbSet.evs } : { hp: 84, atk: 84, def: 84, spa: 84, spd: 84, spe: 84 },
        ivs,
...
var random_teams_default = RandomFERBTeams;
