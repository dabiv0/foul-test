...
getBaseResults=function getBaseResults(){var _this$formatType13,_this$formatType14,_this$formatType15,_this$formatType16;
if(!this.species)return this.getDefaultResults();
var dex=this.dex;
var species=dex.species.get(this.species);
var format=this.format;
...
if(
(_this$formatType17=this.formatType)!=null&&_this$formatType17.startsWith('dlc1')&&(_BattleTeambuilderTab=
BattleTeambuilderTable['gen8dlc1'])!=null&&_BattleTeambuilderTab.nonstandardMoves.includes(moveid))
{
continue;
}
if(
(_this$formatType18=this.formatType)!=null&&_this$formatType18.includes('predlc')&&this.formatType!=='predlcnatdex'&&(_BattleTeambuilderTab2=
BattleTeambuilderTable['gen9predlc'])!=null&&_BattleTeambuilderTab2.nonstandardMoves.includes(moveid))
{
continue;
}
if(
(_this$formatType19=this.formatType)!=null&&_this$formatType19.includes('svdlc1')&&this.formatType!=='svdlc1natdex'&&(_BattleTeambuilderTab3=
