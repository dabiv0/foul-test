...
var serverMsgTime=msgTime-(_this.timeOffset||0);
var mayNotify=serverMsgTime>lastMessageDate&&name!==PS.user.userid;
if(PS.isVisible(_this)){
_this.lastMessageTime=null;
lastMessageDates[PS.server.id][_this.id]=serverMsgTime;
PS.prefs.set('logtimes',lastMessageDates);
}else{

var lastMessageTime=_this.lastMessageTime||0;
if(lastMessageTime<serverMsgTime)_this.lastMessageTime=serverMsgTime;
}
return!!(ChatRoom.getHighlight(message,_this.id)&&mayNotify);
};_this.
