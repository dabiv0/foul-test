...
uploadBg=function(ev){var _this14$base,_input$files;
...
if(!(input!=null&&(_input$files=input.files)!=null&&_input$files[0]))return;
...
_this14.setState({status:"Failed to load background image."});
};
reader.readAsDataURL(file);
ev.preventDefault();
ev.stopImmediatePropagation();
};return _this14;}_inheritsLoose(BackgroundListPanel,_PSRoomPanel12);var _proto14=BackgroundListPanel.prototype;_proto14.
...
handleSubmit=function(ev){var _room$args;
ev.preventDefault();
ev.stopImmediatePropagation();
var room=_this18.props.room;
room.returnValue=(_room$args=room.args)==null?void 0:_room$args.okValue;
...
render=function render(){var _room$args2,_room$args3,_room$args4,_room$args5,_room$args6,_room$args7,_room$args8;
var room=this.props.room;
var okButton=((_room$args2=room.args)==null?void 0:_room$args2.okButton)||'OK';
var cancelButton=(_room$args3=room.args)==null?void 0:_room$args3.cancelButton;
var otherButtons=(_room$args4=room.args)==null?void 0:_room$args4.otherButtons;
var value=(_room$args5=room.args)==null?void 0:_room$args5.value;
var type=((_room$args6=room.args)==null?void 0:_room$args6.type)||(typeof value==='string'?'text':null);
var message=(_room$args7=room.args)==null?void 0:_room$args7.message;
return preact.h(PSPanelWrapper,{room:room,width:((_room$args8=room.args)==null?void 0:_room$args8.width)||480},
...
};return BattleTimerPanel;}(PSRoomPanel);BattleTimerPanel.id='battletimer';BattleTimerPanel.routes=['battletimer'];BattleTimerPanel.location='semimodal-popup';BattleTimerPanel.noURL=true;
