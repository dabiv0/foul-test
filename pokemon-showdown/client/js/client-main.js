...
PS.addRoom({id:toID(title),title:title,connected:true},true);
};
...
if((room==null?void 0:room.type)==="battle"&&!battle.ended&&battle.mySide.id===PS.user.userid){
...
'reconnect':function(){var _this8=this;
if(!PS.isOffline){
...
var battle=PS.rooms[_roomid3]&&PS.rooms[_roomid3].battle;
if(!battle)continue;
...
rooms.length;_i19++){var _roomid4=rooms[_i19];
PS.leave(_roomid4);
}
...
_this11=_PSModel.call(this)||this;_this11.down=false;_this11.prefs=new PSPrefs();_this11.teams=new PSTeams();_this11.user=new PSUser();_this11.server=new PSServer();_this11.connection=null;_this11.connected=false;_this11.isOffline=false;_this11.startTime=Date.now();_this11.router=null;_this11.rooms={};_this11.roomTypes={};_this11.routes=Object.assign(Object.create(null),{"teambuilder":"*","news":"*mini-window","":"*","rooms":"*right","user-*":"*popup","viewuser-*":"*popup","volume":"*popup","options":"*popup","*":"*right","battle-*":"*","battles":"*right","teamdropdown":"*semimodal-popup","formatdropdown":"*semimodal-popup","team-*":"*","ladder":"*","ladder-*":"*","view-*":"*","login":"*semimodal-popup"});_this11.leftRoomList=[];_this11.rightRoomList=[];_this11.miniRoomList=[];_this11.popups=[];_this11.room=null;_this11.panel=null;_this11.leftPanel=null;_this11.rightPanel=null;_this11.leftPanelWidth=0;_this11.mainmenu=null;_this11.dragging=null;_this11.lastMessageTime='';_this11.arrowKeysUsed=false;_this11.newsHTML=((_document$querySelect3=document.querySelector('#room-news .readable-bg'))==null?void 0:_document$querySelect3.innerHTML)||'';_this11.libsLoaded=makeLoadTracker();
...
_this11.addRoom({id:toID(title),title:title,connected:true},true);
}
}
...
addRoom=function addRoom(options){var _options$parentRoomid,_this$getRoom;var noFocus=arguments.length>1&&arguments[1]!==undefined?arguments[1]:false;
...
if(!noFocus){var _options$parentElem;
...
if(this.popups.length&&room.id===this.popups[this.popups.length-1]){var _room$parentRoomid;
this.popups.pop();
PS.room=this.popups.length?PS.rooms[this.popups[this.popups.length-1]]:
PS.rooms[(_room$parentRoomid=room.parentRoomid)!=null?_room$parentRoomid:PS.panel.id]||PS.panel;
}
...
rooms.length;_i35++){var _roomid6=rooms[_i35];
