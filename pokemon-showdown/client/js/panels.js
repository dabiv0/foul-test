...
if(table){var _log;for(var _i6=0,_table$querySelectorA2=
table.querySelectorAll('tr.hidden');_i6<_table$querySelectorA2.length;_i6++){var row=_table$querySelectorA2[_i6];
row.style.display='table-row';
}for(var _i8=0,_table$querySelectorA4=
table.querySelectorAll('tr.no-matches');_i8<_table$querySelectorA4.length;_i8++){var _row=_table$querySelectorA4[_i8];
