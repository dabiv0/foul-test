...
this.pokeballs=[];
(_window=window).BattleItems||(_window.BattleItems={});for(var _i6=0,_Object$values2=
Object.values(BattleItems);_i6<_Object$values2.length;_i6++){var data=_Object$values2[_i6];
...
if(this.pokeballs)return this.pokeballs;
this.pokeballs=[];
(_window2=window).BattleItems||(_window2.BattleItems={});for(var _i8=0,_Object$values4=
Object.values(BattleItems);_i8<_Object$values4.length;_i8++){var data=_Object$values4[_i8];
